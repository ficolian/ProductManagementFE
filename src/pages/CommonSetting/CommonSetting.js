...
// import { ApiGetCommonList, ApiDeleteCommon } from "utils/constants/api";
...
//     const{ data: commonList, fetch: getCommonList } = useFetch(ApiGetCommonList)
//     const{ fetch: getCommonCount } = useFetch(ApiGetCommonList)
...
//     // Function Button
//     function fEditBtnClick(systemId){
//         navigate("/common-setting-form?systemId=" + systemId + "&formType=Edit")
//     }
//     function fDeleteBtnClick(systemId){
...
//             <div >
//                 <span className="font-semibold text-2xl">Common Setting</span>
//             </div>
//             <hr />
...
//                 <button className="button flex gap-2" onClick={() => {navigate("/common-setting-form?systemId=&formType=" + FormTypeAdd)}}>
//                     <PlusIcon />
//                     <span>Add</span>
//                 </button>
//             </div>
...
//                                         <button className="button flex gap-2" onClick={() => fEditBtnClick(data.systemId)}>
