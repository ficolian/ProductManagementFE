...
//                 <div>
//                     <span className="font-semibold">Add Expense Category</span>
//                 </div>
...
//                         </div>
//                         <div className="w-72">
//                             <input className="input" value={categoryName} onChange={(e) => { setCategoryName(e.target.value) }} onKeyDown={(e) => { fEnterKeyDown(e) }} />
//                         </div>
//                     </div>
