...
export default function Booking(){
    ...
    return(
        <div className="flex flex-col gap-2">
            <div >
                <span className="font-semibold text-2xl">Booking</span>
            </div>
            <hr />
            ...
            <div className="flex w-full justify-end">
                <AddButton onClick={() => { navigate("/kost/booking/form?bookingId=&formType=" + FormTypeAdd) }} />
            </div>
