...
function DeleteTebleModal({ data, isSubmitting, onClose }) {
    return (
        <AppModal>
            <div className='flex flex-col items-center gap-8'>
                <div className='flex flex-col items-center text-center gap-2'>
                    <p className='font-bold text-lg'>Are you sure you want to delete this table?</p>
                </div>
...
export default DeleteTebleModal